package testng_Framework.CrossBrowser;
...
public class CrossBrowser_Test 
{
	...
	String browser_path="browser_drivers\\";
	...
	public void launchBrowser(String browser)
	{
		...
		{
		case "firefox":
			System.setProperty("webdriver.gecko.driver",browser_path+"geckodriver.exe");
			driver=new FirefoxDriver();
			break;
			
		case "chrome":
			//Set Runtime environment variable for chrome driver
			System.setProperty("webdriver.chrome.driver", browser_path+"chromedriver.exe");
