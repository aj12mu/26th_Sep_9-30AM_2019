...
public class Verify_Element_Enable_OR_disableState 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		driver.get("https://v1.hdfcbank.com/branch-atm-locator/?lat=17.4358528&long=78.41792&shared=1");  //Load webpage
		driver.manage().window().maximize();  //maximize browser window
				

		/*
		 * Testcase:-->Verify locality editbox without State & city selection
		...
		if(Locality_Editbox.isEnabled())
		{
			...
			Locality_Editbox.sendKeys("Dilsukhnagar");
		}
		else
